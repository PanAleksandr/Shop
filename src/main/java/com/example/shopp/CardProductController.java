...
public class CardProductController implements Initializable {
    ...
    private AdminMainController adminMainController; // link AdminMainController
    ...
    public void setData(ProductData prodData) {
        ...
        image = new Image(path, 90, 194, true, true);
    ...
    public void addBtn() {
        AdminMainController mForm = new AdminMainController();
        mForm.customerID();
        ...
        try {
            ...
            if (checkStck == 0) {
                ...
                String updateStock = "UPDATE product SET prod_name = '" + prod_name.getText() + "', type = '"
                        + type + "', stock = 0, price = " + pr + ", status = 'Unavailable', image = '"
                        + prod_image + "', date = '"
            ...
            if (!check.equals("Available") || qty == 0) {
                ...
                if (checkStck < qty) {
                    ...
                    prepare.setString(9, Data.login_username);
                    ...
                    // Вызов метода обновления данных в AdminMainController
                    if (adminMainController != null) {
                        adminMainController.updateMenuData();
                    }
                }
            }
        } catch (Exception e) {
